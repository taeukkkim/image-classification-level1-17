...
class MaskSplitByProfileDataset(MaskBaseDataset_2):
    """
...
class MaskCroppedDataset(Dataset):
    num_classes = 3 * 2 * 3
    ...
    _file_names = {
        ...
        "incorrect_mask": MaskLabels.INCORRECT,
        "normal": MaskLabels.NORMAL,
        "mask1_cropped": MaskLabels.MASK,
        "mask2_cropped": MaskLabels.MASK,
        "mask3_cropped": MaskLabels.MASK,
        "mask4_cropped": MaskLabels.MASK,
        "mask5_cropped": MaskLabels.MASK,
        "incorrect_mask_cropped": MaskLabels.INCORRECT,
        "normal_cropped": MaskLabels.NORMAL
    }
